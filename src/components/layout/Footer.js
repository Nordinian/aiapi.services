...
const FooterBar = () => {
  ...
  const customFooter = useMemo(() => (
    <footer className="relative h-auto py-6 md:py-8 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-full max-w-[1110px] gap-4 mt-1 md:mt-0">
        <div className="flex flex-wrap items-center justify-center gap-2">
          <Typography.Text className="text-sm !text-semi-color-text-1 text-center">© {currentYear} {systemName}. {t('版权所有')}</Typography.Text>
        </div>
